...
```powershell
$ldflags = "-X 'github.com/alimtvnetwork/gitmap-v20/gitmap/constants.RepoPath=$absRepoRoot'"
...
```
  ...
  ──────────────────────────────────────────────────
  → Runner CWD: D:\wp-work\riseup-asia\gitmap-v20
  → Repo root: D:\wp-work\riseup-asia\gitmap-v20
...
| Repo root | Root of the gitmap-v20 project |
