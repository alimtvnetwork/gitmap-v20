...
**Example:** `git@github.com:alimtvnetwork/gitmap-v20.git`
→ `slug = "gitmap-v20"` → `base = "gitmap"`, `K = 7`.
...
pass (covers Go module import paths like `github.com/x/gitmap-v20` and
...
replace: src/foo.go: 3 matches (gitmap-v20 → gitmap-v20)
replace: docs/setup.md: 1 match (gitmap-v20 → gitmap-v20)
...
