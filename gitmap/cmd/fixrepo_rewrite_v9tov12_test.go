...
import (
	...
	"github.com/alimtvnetwork/gitmap-v20/gitmap/fixtureversion"
)
...
// adjacent token (`gitmap-v20`) that MUST NOT match `gitmap-v20`.
...
//
// IMPORTANT: this body MUST contain `gitmap-v20` tokens (the rewrite
// target) and a `gitmap-v20` guarded neighbor. A previous global
...
// project's own module suffix (`gitmap`) collapses to `gitmap-v20` /
...
// `gitmap-v20` must survive untouched when bumping target=9, because
