...
func TestSlugFromRemote(t *testing.T) {
	cases := map[string]string{
		"https://github.com/alimtvnetwork/gitmap-v20.git": "gitmap-v20",
		"https://github.com/alimtvnetwork/gitmap-v20":     "gitmap-v20",
		"git@github.com:alimtvnetwork/gitmap-v20.git":     "gitmap-v20",
		"git@github.com:alimtvnetwork/gitmap-v20":         "gitmap-v20",
		"ssh://git@host.example/foo/bar/gitmap-v20.git":   "gitmap-v20",
		"gitmap-v20":     "gitmap-v20",
		"gitmap-v20.git": "gitmap-v20",
	}
...
// `current` value — historically this test pinned `gitmap-v20` next to
...
// `gitmap-v20` next to a `current=9` argument.
