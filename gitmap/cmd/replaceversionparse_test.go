...
func TestSlugFromRemote(t *testing.T) {
	cases := map[string]string{
		...
		"git@github.com:alimtvnetwork/gitmap-v18.git":     "gitmap-v18",
		"git@github.com:alimtvnetwork/gitmap-v18":         "gitmap-v18",
		"ssh://git@host.example/foo/bar/gitmap-v18.git":   "gitmap-v18",
		"gitmap-v18":     "gitmap-v18",
		"gitmap-v18.git": "gitmap-v18",
	}
...
// `current` value — historically this test pinned `gitmap-v18` next to
...
// `gitmap-v18` next to a `current=9` argument.
