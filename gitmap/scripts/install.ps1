...
.NOTES
    Repository: https://github.com/alimtvnetwork/gitmap-v19
#>
...
function Install-Binary([string]$zipPath, [string]$installDir) {
    ...
    # Match exact names OR versioned patterns like gitmap-v19.54.6-windows-amd64.exe
    $candidateNames = @(
        $BinaryName,
...
function global:gcd { Invoke-GitmapAndSetLocation @('cd') + $args }
