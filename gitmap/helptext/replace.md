...
### Version bump (`-3` on a `gitmap-v18` repo)

```
$ gitmap replace -3

  replace: scanning 412 files in /repo
  replace: go.mod: 1 match (gitmap-v18 -> gitmap-v18)
  replace: docs/upgrade.md: 4 matches (gitmap-v18 -> gitmap-v18)
...
$ gitmap replace --audit
  ...
  README.md:42: see https://github.com/x/gitmap-v18 for the legacy guide
  go.mod:3: module github.com/x/gitmap-v18
```
