...
[![CI](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/ci.yml)
[![Vulncheck](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/vulncheck.yml/badge.svg?branch=main)](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/vulncheck.yml)
[![Cross-platform](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/cross-platform.yml/badge.svg?branch=main)](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/cross-platform.yml)
[![Startup build tags](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/startup-build-tags.yml/badge.svg?branch=main)](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/startup-build-tags.yml)
...
### 📌 Pinned version (`v4.43.0`)

```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/release-version-v4.43.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/release-version-v4.43.0.sh | bash
```

#### 🧭 Version matrix — `v4.43.0` install-script URLs

One-line installers and release assets for the pinned **v4.43.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.

| Platform | Shell | Install-script URL | Release binary asset |
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v4.43.0.ps1`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/release-version-v4.43.0.ps1) | [`gitmap-v19.43.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/gitmap-v19.43.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v4.43.0.sh`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/release-version-v4.43.0.sh) | [`gitmap-v19.43.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/gitmap-v19.43.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v4.43.0.sh`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/release-version-v4.43.0.sh) | [`gitmap-v19.43.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/gitmap-v19.43.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v4.43.0.sh`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/release-version-v4.43.0.sh) | [`gitmap-v19.43.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/gitmap-v19.43.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v4.43.0.sh`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/release-version-v4.43.0.sh) | [`gitmap-v19.43.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v4.43.0/gitmap-v19.43.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v19/releases/tag/v4.43.0](https://github.com/alimtvnetwork/gitmap-v19/releases/tag/v4.43.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
