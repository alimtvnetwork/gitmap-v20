...
### 📌 Pinned version (`v5.28.0`)

```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/release-version-v5.28.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/release-version-v5.28.0.sh | bash
```

#### 🧭 Version matrix — `v5.28.0` install-script URLs

One-line installers and release assets for the pinned **v5.28.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.

| Platform | Shell | Install-script URL | Release binary asset |
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v5.28.0.ps1`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/release-version-v5.28.0.ps1) | [`gitmap-v20.45.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/gitmap-v20.45.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v5.28.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/release-version-v5.28.0.sh) | [`gitmap-v20.45.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/gitmap-v20.45.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v5.28.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/release-version-v5.28.0.sh) | [`gitmap-v20.45.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/gitmap-v20.45.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v5.28.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/release-version-v5.28.0.sh) | [`gitmap-v20.45.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/gitmap-v20.45.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v5.28.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/release-version-v5.28.0.sh) | [`gitmap-v20.45.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.28.0/gitmap-v20.45.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v20/releases/tag/v5.28.0](https://github.com/alimtvnetwork/gitmap-v20/releases/tag/v5.28.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/install.ps1'))
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/install.ps1 | iex; Install-Gitmap -Version "v2.51.0"
```

**Specific version + custom directory (one-liner):**

```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/install.ps1 | iex; Install-Gitmap -Version "v2.51.0" -InstallDir "D:\DevTools\gitmap"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/install.sh | sh -s -- --version v2.51.0
```
...
$ver = 'v3.50.0'
$installer = irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/install.ps1
& ([scriptblock]::Create($installer)) -Version $ver -NoDiscovery
```

```bash
# Linux / macOS — install v3.50.0 exactly
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/install.sh \
