...
[![Go Report Card](https://goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v20/gitmap?style=flat-square)](https://goreportcard.com/report/github.com/alimtvnetwork/gitmap-v20/gitmap)
...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/release-version-v5.12.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/release-version-v5.12.0.sh | bash
```

#### 🧭 Version matrix — `v5.12.0` install-script URLs

One-line installers and release assets for the pinned **v5.12.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.

| Platform | Shell | Install-script URL | Release binary asset |
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v5.12.0.ps1`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/release-version-v5.12.0.ps1) | [`gitmap-v20.44.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/gitmap-v20.44.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v5.12.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/release-version-v5.12.0.sh) | [`gitmap-v20.44.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/gitmap-v20.44.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v5.12.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/release-version-v5.12.0.sh) | [`gitmap-v20.44.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/gitmap-v20.44.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v5.12.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/release-version-v5.12.0.sh) | [`gitmap-v20.44.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/gitmap-v20.44.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v5.12.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/release-version-v5.12.0.sh) | [`gitmap-v20.44.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.12.0/gitmap-v20.44.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v20/releases/tag/v5.12.0](https://github.com/alimtvnetwork/gitmap-v20/releases/tag/v5.12.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
...
```powershell
# Windows · PowerShell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/install-quick.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/install-quick.sh | bash
```
...
**GitMap** ([this repository](https://github.com/alimtvnetwork/gitmap-v20))
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/uninstall-quick.ps1 | iex
```

#### Linux / macOS

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/uninstall-quick.sh | bash
```
...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/gitmap/scripts/install.ps1'))
```
...
1. **Use `--allow-fallback`** — Automatically picks the newest patch in the same
   ...
   ```powershell
   irm https://github.com/alimtvnetwork/gitmap-v20/releases/download/v3.38.0/release-version-v3.38.0.ps1 | iex
...
| Script | URL Pattern |
|--------|-------------|
| Pinned PowerShell | `https://github.com/alimtvnetwork/gitmap-v20/releases/download/{version}/release-version-{version}.ps1` |
| Pinned Bash | `https://github.com/alimtvnetwork/gitmap-v20/releases/download/{version}/release-version-{version}.sh` |
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/gitmap/scripts/install.ps1 | iex; Install-Gitmap -Version "v2.51.0"
```

**Specific version + custom directory (one-liner):**

```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/gitmap/scripts/install.ps1 | iex; Install-Gitmap -Version "v2.51.0" -InstallDir "D:\DevTools\gitmap"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/gitmap/scripts/install.sh | sh -s -- --version v2.51.0
```
...
```bash
git clone https://github.com/alimtvnetwork/gitmap-v20.git gitmap
```
...
gitmap clone https://github.com/alimtvnetwork/gitmap-v20
...
gitmap merge-both https://github.com/alimtvnetwork/gitmap-v20 \
                  https://github.com/alimtvnetwork/gitmap-v20

# merge-left: take RIGHT into LEFT
gitmap merge-left ./gitmap-v20 ./gitmap-v20
gitmap merge-left ./local https://github.com/alimtvnetwork/gitmap-v20

# merge-right: take LEFT into RIGHT
gitmap merge-right ./gitmap-v20 ./gitmap-v20
gitmap merge-right ./local https://github.com/alimtvnetwork/gitmap-v20

# bypass conflict prompts: source-side wins by default
gitmap merge-right ./gitmap-v20 ./gitmap-v20 -y
gitmap merge-both  ./gitmap-v20 ./gitmap-v20 -y --prefer-newer
...
$ver = 'v3.50.0'
$installer = irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/gitmap/scripts/install.ps1
& ([scriptblock]::Create($installer)) -Version $ver -NoDiscovery
```

```bash
# Linux / macOS — install v3.50.0 exactly
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v20/main/gitmap/scripts/install.sh \
...
- 🐛 **Fixes:** README badge now points at `goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v20/gitmap` (real module path) instead of the repo root, which 404'd because there is no `go.mod` at the root.
...
- 💥 **Breaking:** `go.mod` module path renamed from a placeholder to `github.com/alimtvnetwork/gitmap-v20/gitmap`. Anyone importing the module by the old path must update their import lines. CLI users are unaffected.
...
> Versions older than v3.22 are summarized in [`CHANGELOG.md`](CHANGELOG.md). Notable jumps: **v3.21** (schema-version fast path + `db-migrate --force`), **v3.19** (bare release auto-bumps **minor** + multi-repo scan-dir release), **v3.17** (`Release.RepoId` foreign key + doctor duplicate-binary check), **v3.16** (repo renamed to `gitmap-v20`).
...
[
  ...
  {
    "repoName": "gitmap-v20",
    "httpsUrl": "https://github.com/alimtvnetwork/gitmap-v20.git",
    "relativePath": "gitmap-v20",
    "depth": 1
  }
]
```
...
gitmap-v20,git@github.com:alimtvnetwork/gitmap-v20.git,,gitmap-v20
```
