...
[![CI](https://img.shields.io/github/actions/workflow/status/alimtvnetwork/gitmap-v19/ci.yml?branch=main&style=flat-square&label=CI)](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/ci.yml)
[![Vulnerability Scan](https://img.shields.io/github/actions/workflow/status/alimtvnetwork/gitmap-v19/vulncheck.yml?branch=main&style=flat-square&label=vulnerability%20scan)](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/vulncheck.yml)
[![Cross-Platform Build](https://img.shields.io/github/actions/workflow/status/alimtvnetwork/gitmap-v19/cross-platform.yml?branch=main&style=flat-square&label=cross-platform%20build)](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/cross-platform.yml)
[![Startup Build-Tag Guard](https://img.shields.io/github/actions/workflow/status/alimtvnetwork/gitmap-v19/startup-build-tags.yml?branch=main&style=flat-square&label=startup%20build-tag%20guard)](https://github.com/alimtvnetwork/gitmap-v19/actions/workflows/startup-build-tags.yml)
...
### 📌 Pinned version (`v5.10.0`)

```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/release-version-v5.10.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/release-version-v5.10.0.sh | bash
```

#### 🧭 Version matrix — `v5.10.0` install-script URLs

One-line installers and release assets for the pinned **v5.10.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.

| Platform | Shell | Install-script URL | Release binary asset |
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v5.10.0.ps1`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/release-version-v5.10.0.ps1) | [`gitmap-v19.5.10.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/gitmap-v19.5.10.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v5.10.0.sh`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/release-version-v5.10.0.sh) | [`gitmap-v19.5.10.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/gitmap-v19.5.10.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v5.10.0.sh`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/release-version-v5.10.0.sh) | [`gitmap-v19.5.10.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/gitmap-v19.5.10.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v5.10.0.sh`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/release-version-v5.10.0.sh) | [`gitmap-v19.5.10.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/gitmap-v19.5.10.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v5.10.0.sh`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/release-version-v5.10.0.sh) | [`gitmap-v19.5.10.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v19/releases/download/v5.10.0/gitmap-v19.5.10.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v19/releases/tag/v5.10.0](https://github.com/alimtvnetwork/gitmap-v19/releases/tag/v5.10.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
